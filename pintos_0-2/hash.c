...
unsigned hash_func (const struct hash_elem *e, void *aux) {
	...
	unsigned num = (hash_entry(e, struct hash_item, h_elem))->data;
	
	unsigned ret = hash_int(num);
...
bool hash_less (const struct hash_elem *a, const struct hash_elem *b, void *aux) {
	...
	int x = hash_entry(a, struct hash_item, h_elem)->data;
	int y = hash_entry(b, struct hash_item, h_elem)->data;
...
void hash_square (struct hash_elem *e, void *aux) {
	...
	struct hash_item* node = hash_entry(e, struct hash_item, h_elem);
